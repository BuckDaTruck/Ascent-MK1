...
Servo servoD5; // Servo object for pin D5
...
void loop() {
  ...
  int servoAngleD5 = map(accelX_deg, -90, 90, 0, 180);
  int servoAngleD6 = map(accelY_deg, -90, 90, 0, 180);

  // Set servo positions
  servoD5.write(servoAngleD5);
  servoD6.write(servoAngleD6);

  Serial.print("Servo D5 angle: ");
  Serial.print(servoAngleD5);
